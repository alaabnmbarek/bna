...
import { tap, Observable, fromEvent, map, merge, takeUntil, switchMap, EMPTY, of, pluck, Subject, distinctUntilChanged, animationFrameScheduler, mergeMap, BehaviorSubject, debounceTime, Subscription, pairwise, filter, auditTime } from 'rxjs';
...
class NgAttr {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: NgAttr, isStandalone: true, selector: "[ngAttr]", inputs: { ngAttr: "ngAttr" }, ngImport: i0 }); }
}
...
class TrackXDirective extends TrackAdapter {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: TrackXDirective, isStandalone: true, selector: "[scrollbarTrackX]", usesInheritance: true, ngImport: i0 }); }
}
...
class TrackYDirective extends TrackAdapter {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: TrackYDirective, isStandalone: true, selector: "[scrollbarTrackY]", usesInheritance: true, ngImport: i0 }); }
}
...
class ThumbXDirective extends ThumbAdapter {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: ThumbXDirective, isStandalone: true, selector: "[scrollbarThumbX]", usesInheritance: true, ngImport: i0 }); }
}
...
class ThumbYDirective extends ThumbAdapter {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: ThumbYDirective, isStandalone: true, selector: "[scrollbarThumbY]", usesInheritance: true, ngImport: i0 }); }
}
...
class ScrollbarY extends Scrollbar {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.1.2", type: ScrollbarY, isStandalone: true, selector: "scrollbar-y", host: { properties: { "class.scrollbar-control": "true" } }, viewQueries: [{ propertyName: "track", first: true, predicate: TrackYDirective, descendants: true, static: true }, { propertyName: "thumb", first: true, predicate: ThumbYDirective, descendants: true, static: true }], usesInheritance: true, ngImport: i0, template: `
...
class ScrollbarX extends Scrollbar {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.1.2", type: ScrollbarX, isStandalone: true, selector: "scrollbar-x", host: { properties: { "class.scrollbar-control": "true" } }, viewQueries: [{ propertyName: "track", first: true, predicate: TrackXDirective, descendants: true, static: true }, { propertyName: "thumb", first: true, predicate: ThumbXDirective, descendants: true, static: true }], usesInheritance: true, ngImport: i0, template: `
...
class HideNativeScrollbar {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: HideNativeScrollbar, isStandalone: true, selector: "[hideNativeScrollbar]", ngImport: i0 }); }
}
...
class ResizeSensor {
    ...
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "16.1.2", type: ResizeSensor, isStandalone: true, selector: "[resizeSensor]", inputs: { debounce: ["sensorDebounce", "debounce"], disabled: ["sensorDisabled", "disabled"] }, outputs: { event: "resizeSensor" }, ngImport: i0 }); }
}
...
class NgScrollbarModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.2", ngImport: i0, type: NgScrollbarModule, imports: [NgScrollbar,
            ScrollViewport], exports: [NgScrollbar,
            ScrollViewport] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.2", ngImport: i0, type: NgScrollbarModule }); }
}
